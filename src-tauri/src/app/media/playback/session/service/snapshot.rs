...
pub(super) fn export_playback_state(model: &PlaybackSessionModel) -> PlaybackState {
    PlaybackState {
        ...
        title: model.source.title.clone(),
        artist: model.source.artist.clone(),
        album: model.source.album.clone(),
        has_cover_art: model.source.has_cover_art,
        lyrics: model.source.lyrics.clone(),
        lyrics_source: model.source.lyrics_source.clone(),
        lyrics_candidate_id: model.source.lyrics_candidate_id.clone(),
        lyrics_candidates: model.source.lyrics_candidates.clone(),
        lyrics_fetching: model.source.lyrics_fetching,

...
export const CIRCLE_BTN_BASE =
  "inline-flex h-9 min-h-9 w-9 min-w-9 items-center justify-center rounded-full p-0! leading-none transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/25 focus-visible:ring-offset-2 focus-visible:ring-offset-black/30 [&_.ant-btn-icon]:m-0! [&_.ant-btn-icon]:flex [&_.ant-btn-icon]:items-center [&_.ant-btn-icon]:justify-center disabled:opacity-55 disabled:cursor-not-allowed";

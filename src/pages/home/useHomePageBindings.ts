...
export function useHomePageBindings(viewModel: HomePageViewModel) {
  ...
  const mediaViewportProps = computed(() => ({
    ...
    debugSnapshot: viewModel.debugSnapshot.value,
    debugTimeline: viewModel.debugTimeline.value,
    debugStageSnapshot: viewModel.debugStageSnapshot.value,
    firstFrameAtMs: viewModel.firstFrameAtMs.value,
    latestTelemetry: viewModel.latestTelemetry.value,
    latestAudioMeter: viewModel.latestAudioMeter.value,
    telemetryHistory: viewModel.telemetryHistory.value,
    mediaInfoSnapshot: viewModel.mediaInfoSnapshot.value,
